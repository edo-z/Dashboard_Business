...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($name && $email && $password) {
        ...
        if (isset($response['message']) && $response['message'] === "Registrasi berhasil") {
            $success = "Registrasi berhasil. Silakan hubungi Admin untuk mendapatkan akses!";
        } else {
...
<head>
    ...
    <title>Register - Mokko Project</title>
        ...
        <div class="form-container rounded-2xl p-8 subtle-shadow">
            ...
            <div class="text-center mb-8">
                <div class="inline-flex items-center justify-center w-12 h-12 mb-4">
                    <i class="text-3xl logo-accent fas fa-user-plus"></i>
                </div>
            ...
            <?php if ($success): ?>
                ...
                <div class="text-center mb-6">
                    <a href="login.php" class="btn-primary inline-block py-3 px-6 text-white font-medium rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-un-blue-2">
                        Masuk
                    </a>
                </div>
            <?php else: ?>
                ...
                <form method="POST" id="registerForm" class="space-y-5">
                    ...
                    <div class="form-group input-wrapper">
                        <label for="name" class="block form-label mb-2">Nama Lengkap</label>
                        <div class="relative">
